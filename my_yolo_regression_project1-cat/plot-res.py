...
val_loss_file = (
    r"C:\Users\User\Desktop\焊接\ultralytics-main\ultralytics-main\my_yolo_regression_project1-cat\runs\val_losses.txt"
)
val_mae_file = (
    r"C:\Users\User\Desktop\焊接\ultralytics-main\ultralytics-main\my_yolo_regression_project1-cat\runs\val_maes.txt"
)
val_r2_file = (
    r"C:\Users\User\Desktop\焊接\ultralytics-main\ultralytics-main\my_yolo_regression_project1-cat\runs\val_r2s.txt"
)
