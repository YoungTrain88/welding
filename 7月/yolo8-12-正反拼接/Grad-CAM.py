...
RUNS_DIR = os.path.join(PROJECT_ROOT)
IMAGE_PATH = os.path.join(PROJECT_ROOT,  'datasets', 'images', '100359正_拼接.jpg')
YAML_PATH = os.path.join(PROJECT_ROOT, 'yaml', 'yoloV11n-r-att-conv.yaml')  # 你的yaml结构文件
